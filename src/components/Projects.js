      ...
      <Card.Group>
        ...
        <Card color='red'>
          ...
          <Card.Content>
            ...
            <Label as='a' color='teal' image attached='top right'>
        ...
        <Card color='red'>
          ...
          <Card.Content>
            ...
            <Card.Description>
              ...
              The main goal was to be able to pull info via external API and have a simple UI to view data, 
              while exploring a new CSS library.
            </Card.Description>
          </Card.Content>
          <Card.Content>
            <Card.Meta>
